  ...
  let carData = [
      ...
      carInstallmentDetails: [
        {
          ...
          carMonthPaid: { percentPerMonth: [3.89, 4.19, 4.49, 4.79] },
        },
        {
          carRatePricePercent: 15,
          carMonthPaid: { percentPerMonth: [3.29, 3.59, 3.79, 4.49] },
        },
        {
          carRatePricePercent: 20,
          carMonthPaid: { percentPerMonth: [2.79, 2.99, 3.39, 3.99] },
        },
        {
          carRatePricePercent: 25,
          carMonthPaid: { percentPerMonth: [1.98, 2.79, 3.19, 3.89] },
        },
        {
          carRatePricePercent: 30,
          carMonthPaid: { percentPerMonth: [1.98, 2.55, 3.09, 3.79] },
        },
      ],
    },
    ...
    //DENZA D9 Premium
    {
      ...
      carInstallmentDetails: [
        {
          carRatePricePercent: 10,
          carMonthPaid: { percentPerMonth: [3.79, 4.09, 4.39, 4.69] },
        },
        {
          carRatePricePercent: 15,
          carMonthPaid: { percentPerMonth: [3.19, 3.49, 3.69, 4.39] },
        },
        {
          carRatePricePercent: 20,
          carMonthPaid: { percentPerMonth: [2.69, 2.89, 3.29, 3.89] },
        },
        {
          carRatePricePercent: 25,
          carMonthPaid: { percentPerMonth: [1.88, 2.69, 3.09, 3.79] },
        },
        {
          carRatePricePercent: 30,
          carMonthPaid: { percentPerMonth: [1.88, 2.45, 2.99, 3.69] },
        },
      ],
    },
